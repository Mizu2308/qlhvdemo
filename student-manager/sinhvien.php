							...
							<?php
								...
								if(mysqli_num_rows($result) > 0){
									...
									while ($r = mysqli_fetch_assoc($result)){
										...
										echo "<td>$sdt</td>"	;
										echo "<td>$quequan</td>"	;
										echo " <td style='text-align: center;'> <a href='chucnang/themsvvaolop.php?id=$sinhvienID'><input id='btnXoa' type='button' value='Thêm'> <a href='chucnang/suasv.php?id=$sinhvienID'><input id='btnSua' type='button' value='sửa' '></a>   <a href='chucnang/xoasv.php?id=$sinhvienID'><input id='btnXoa' type='button' value='xóa'> </a> <a href='thongtinsv.php?id=$sinhvienID'><input id='btnChitiet' type='button' value='chi  tiết' '></a>  </td>";
