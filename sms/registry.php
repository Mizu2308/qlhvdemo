...
<body>
    ...
    function check_data($data)
    {
        ...
        $data = htmlspecialchars($data);  //Bỏ tác dụng của thẻ HTML, tương tự hàm htmlentities()         return $data; 
    }
    ?>
    <div id="container">
        <div id="div1"></div>
        <div id="div2">
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" name="Register" method="post">
                <table cellpadding="5" cellspacing="0" id="table_form" align="center">
                    <tr>
                        <td width="30%" class="col1"><label for="username">Họ và tên người dùng:</label></td>
                    ...
                    <tr>
                        ...
                        <td><input type="password" size="40" id="password" name="password" value="<?php echo $password ?>"></input><span id="erPass" class="error">*</span></td>
                    </tr>
                    <tr>
